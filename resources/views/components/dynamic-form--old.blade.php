@props([
    ...
    'method' => 'POST',
    'fields' => [],
    'data' => [], // ← NUEVO: Array con datos del servidor
    'submitText' => 'Guardar',
    'submitColor' => 'teal',
    'cancelText' => null,
    'cancelRoute' => null,
...
@php
    ...
    // Inicializar datos de Alpine
    $alpineData = [];
    foreach ($conditions as $condition) {
        $alpineData[$condition['key']] = $condition['value'] ? 'true' : 'false'; // Por defecto true, se puede cambiar según necesidad
    }
...
<div 
    ...
    >
        ...
        <div class="space-y-6">
            @foreach($fields as $field)
                <x-dynamic-form-field :field="$field" />
            @endforeach
        </div>
